            ...
            $(function () {
                ...
                $("#search-btn").click(function () {
                    $('#dataList').datagrid('load', {
                        ...
                        gradeId: $('#search-grade-id').combobox('getValue'),  //获取年级ID
                    });
                });
            });
    </script>
...
<div id="toolbar">
    ...
    <div style="margin-left: 10px;">
        ...
        <a id="edit" href="javascript:" class="easyui-linkbutton"
           data-options="iconCls:'icon-user-teacher',plain:true"/>
        班级
        <input id="search-name" class="easyui-textbox" name="name"/>
        所属年级<select id="search-grade-id" class="easyui-combobox" style="width: 100px;">
...
<div id="addDialog" style="padding: 15px 0 0 15px;">
    ...
    <form id="addForm" method="post" action="#">
        <table id="addTable" border=0 style="width:200px; table-layout:fixed;" cellpad ding="6">
            ...
            <tr>
                <td>备注</td>
                <td colspan="4"><input id="add_remark" style="width: 200px; height: 220px;" class="easyui-textbox"
    ...
    <form id="editForm" method="post" action="#">
        ...
        <table id="editTable" border=0 style="width:160px; table-layout:fixed;" cellpadding="8">
            ...
            <tr>
                <td>所属年级</td>
                <td>
                    <select id="edit_gradeId" style="width: 200px; height: 30px;" class="easyui-combobox" type="text"
                            name="gradeId" data-options="required:true, missingMessage:'请选择所属年级~'">
                        <c:forEach items="${gradeList}" var="temp">
                            <option value="${temp.id}">${temp.name}</option>
                        </c:forEach>
